...
class _ColorSliderState extends State<ColorSlider> {
  ...
  Color _getInterpolatedColor(double value) {
    ...
    return Color.lerp(widget.colors[index], widget.colors[index + 1], t) ?? widget.colors[index];
  }
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            Text("${_selectedColor.value.toRadixString(16)}", style: Theme.of(context).textTheme.labelSmall!.copyWith(
                color: ColorManager.grey
            ),),
          ],
        )
