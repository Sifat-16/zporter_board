...
import 'package:zporter_board/features/tacticV2/presentation/view/component/lefttoolbarV2/players_toolbar_component_v2.dart';

class LefttoolbarComponentV2 extends StatefulWidget {
  const LefttoolbarComponentV2({super.key});

  @override
  State<LefttoolbarComponentV2> createState() => _LefttoolbarComponentV2State();
}

class _LefttoolbarComponentV2State extends State<LefttoolbarComponentV2> with SingleTickerProviderStateMixin {
  ...
  final List<Map<String, dynamic>> _tabs = [
    {'title': 'Players', 'content': PlayersToolbarComponentV2()},
