...
class PlayerUtilsV2{
  ...
  static List<PlayerModelV2> generatePlayerModelList({required PlayerType playerType}){
    List<PlayerModelV2> generatedPlayers = [];
    int index=1;
    for(String p in players){
      ObjectId id = ObjectId();
      PlayerModelV2 playerModelV2 = PlayerModelV2(id:id.oid, role: p, index: index, playerType: playerType);
