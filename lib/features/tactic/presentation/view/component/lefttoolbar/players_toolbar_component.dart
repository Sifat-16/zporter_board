...
class PlayersToolbarComponent extends StatefulWidget {
  ...
  @override
  State<PlayersToolbarComponent> createState() => _PlayersToolbarComponentState();
}

class _PlayersToolbarComponentState extends State<PlayersToolbarComponent> with SingleTickerProviderStateMixin {
